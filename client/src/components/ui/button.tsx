...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors duration-150 cursor-pointer disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-golden-glow text-shadow-grey hover:bg-banana-cream',
        destructive:
          'bg-red-600 text-white hover:bg-red-700',
        outline:
          'border border-border bg-transparent text-porcelain hover:bg-surface',
        secondary:
          'bg-surface text-porcelain hover:bg-surface-hover',
        ghost:
          'text-porcelain hover:bg-surface',
        link:
          'text-golden-glow underline-offset-4 hover:underline',
      },
      size: {
